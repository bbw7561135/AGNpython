...
class Pencil_Analysis(object):
        ...
        try: 
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    try:
                        print('================')
                        print('Making Energy plot for '+str(data_frame[n]['DirName']))
                        print('================')
                    except:
                        print('================')
                        print('Dir error')
		    ...
		    KE_Sum_Label		 = mpatches.Patch(color='green',label='Kinetic')
		    UE_Sum_Label		 = mpatches.Patch(color='red',label='Potential')
		    UINT_Sum_Label		 = mpatches.Patch(color='purple',label='Internal')
		    OE_Sum_Label		 = mpatches.Patch(color='orange',label='Orbital')	
		    Total_Label			 = mpatches.Patch(color='blue',label='Total')
		    fit_Label			 = mpatches.Patch(color='black',label='fit')
		    KE_rate_Label		 = mpatches.Patch(color='white',label='Pencil derivative :'+str(KE_rate))
		    UE_rate_Label		 = mpatches.Patch(color='white',label='Pencil derivative :'+str(UE_rate))
 		    UINT_rate_Label		 = mpatches.Patch(color='white',label='Pencil derivative :'+str(UINT_rate))
		    OE_rate_Label		 = mpatches.Patch(color='white',label='Pencil derivative :'+str(OE_rate))
		    KE_fr_Label			 = mpatches.Patch(color='white',label='fit derivative : '+str(KE_fit_rate))
		    UE_fr_Label			 = mpatches.Patch(color='white',label='fit derivative : '+str(UE_fit_rate))
		    UINT_fr_Label		 = mpatches.Patch(color='white',label='fit derivative : '+str(UINT_fit_rate))
		    OE_fr_Label			 = mpatches.Patch(color='white',label='fit derivative : '+str(OE_fit_rate))
		    KE_error_Label		 = mpatches.Patch(color='white',label='error :'+str(KE_error))
		    UE_error_Label		 = mpatches.Patch(color='white',label='error :'+str(UE_error))
		    UINT_error_Label		 = mpatches.Patch(color='white',label='error :'+str(UINT_error))
		    OE_error_Label		 = mpatches.Patch(color='white',label='error :'+str(OE_error))
		    ...
		    plt.plot(UINT_Sum,color='purple',label='Internal',ls='-.')
		    plt.plot(np.abs(Total[:]),color='blue',label='Total disk energy')
		    ...
		    plt.legend(handles=[DirMass_patches,
					...
					UINT_Sum_Label,
					OE_Sum_Label],loc=2)
		    plt.savefig('Standard_ErgMC_'+str(data_frame[n]['DirName'])+'.png')
		    plt.close()
		    ...
		    plt.figure(figsize=(10,10))
		    plt.title('Energy Magnitude Comparison')
                    plt.plot(np.abs(Total_Avg[:]),color='blue',label='Total disk energy',ls='--')
		    plt.xlabel('time (Orbits)',fontweight='bold')
		    plt.ylabel('Joule (Code units)',fontweight='bold')
		    plt.tight_layout()
		    plt.grid(True)
		    ...
		    plt.savefig('Standard_ErgTot_'+str(data_frame[n]['DirName'])+'.png')
		    plt.close()
		    ...
		    plt.figure(figsize=(10,10))
		    plt.title('Energy Magnitude Comparison')
                    plt.plot(eccentricity[:len(Total_Avg[:])],np.abs(Total_Avg[:]),color='blue',label='Total disk energy',ls=':')
		    ...
		    plt.legend(handles=[DirMass_patches,
                                        ...
                                        Dir_alpha_patches,
                                        Dir_beta_patches],loc=2)
		    plt.savefig('Standard_ErgEcc_'+str(data_frame[n]['DirName'])+'.png')
		    plt.close()
		    ...
		    plt.title('Disk Potential Energy')
                    plt.plot(UE_Sum,color='red',label='Disk Potential Energy',ls='--')
		    ...
		    plt.savefig('Standard_ErgUE_'+str(data_frame[n]['DirName'])+'.png')
		    plt.close()
		    ...
		    plt.title('Disk Kinetic Energy')
                    plt.plot(KE_Sum,color='green',label='Disk Kinetic Energy',ls='--')
                    if Calc_Rates_Energy == True:
                        #plot rates and check error
		    ...
		    plt.savefig('Standard_ErgKE_'+str(data_frame[n]['DirName'])+'.png')
		    plt.close()
		    ...
		    plt.title('Disk Internal Energy')
                    plt.plot(UINT_Sum,color='purple',label='Disk Internal Energy',ls='--')
                    if Calc_Rates_Energy == True:
                        #plot rates and check error
                        plt.plot(UINT_fit,color='black',label='UINT fit',ls=':')
		    plt.xlabel('time (Orbits)',fontweight='bold')
		    plt.ylabel('Joule (Code units)',fontweight='bold')
		    plt.tight_layout()
		    plt.grid(True)
		    ...
		    plt.savefig('Standard_ErgUINT_'+str(data_frame[n]['DirName'])+'.png')
		    plt.close()
		    ...
		    plt.title('Orbital Energy')
                    plt.plot(OE_Sum,color='orange',label='Orbital Energy',ls='--')
                    if Calc_Rates_Energy == True:
                        #plot rates and check error
		    ...
		    plt.savefig('Standard_ErgOE_'+str(data_frame[n]['DirName'])+'.png')
		    plt.close()
    ...
    def pingGTM_Sigma(self,data_frame):
        ...
        while i <= len(data_frame)-1:
            try:
                try:
                    ...
                    DirEcc_GTM.append(round(eccentricity[0],1))
                    print('================')
                    print('no Data for GTM_Sigma in'+str(date_frame[i]['DirName']))
                    print('================')
                    traceback.print_exc()
            except:
                    print('================')
        ...
        try:
            ...
            ax.scatter(DirEcc_GTM,DirMass_GTM,c=GTM_Sigma_AllOrbits,marker='o')
            ...
            plt.title(r'global $\sigma_{T}$ as a function of mass ratio and eccentricity')
        ...
        try:
            ...
            while n <= len(DirEcc_GTM)-1:
                try:
                    ...
                    try:
                        print('================')
                        print('Making Sigma Temp Slices plot for '+str(data_frame[n]['DirName']))
                        print('================')
                    except:
                        print('================')
                        print('Dir error')
                    ...
                    plt.savefig('Global_SigmaT_Slices_'+str(DirEcc_GTM[n])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
                    os.system('git add *.png')
    ...
    def pingGTM_Sigma_O(self,data_frame):
        ...
        try:
            ...
            plt.suptitle(r'global $\sigma_{T}$ as a function of mass ratio and eccentricity')
            ax.set_ylabel('q',fontsize=14)
            ax.set_xlabel(r'$\varepsilon$',fontsize=14)
            #ax.set_zlabel(r'global $\sigma_{T}$',fontsize=14)
            #plt.show()
        ...
        try:
            ...
            while n <= len(DirEcc_GTM)-1:
                try:
                    ...
                    plt.savefig('Global_SigmaTi_O_Slices_'+str(DirEcc_GTM[n])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
                    os.system('git add *.png')
    ...
    def pingGTM_O_DT(self,data_frame):
        ...
        try:
            ...
            plt.suptitle(r'$\frac{\partial T}{\partial t}$ as a function of mass ratio and eccentricity')
            ax.set_ylabel('q',fontsize=14)
            ax.set_xlabel(r'$\varepsilon$',fontsize=14)
            #ax.set_zlabel(r'global $\sigma_{T}$',fontsize=14)
            #plt.show()
        ...
        try:
            ...
            while n <= len(DirEcc_GTM)-1:
                try:
                    ...
                    try:
                        print('================')
                        print('Making DTemp Slices plot for '+str(data_frame[n]['DirName']))
                        print('================')
                    except:
                        print('================')
                        print('Dir error')
                    ...
                    plt.savefig('Global_dT_O_Slices_'+str(DirEcc_GTM[n])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
                    os.system('git add *.png')
    ...
    def pingGTM_Sigma_3D(self,data_frame):
        ...
        try:
            ...
            ax = fig.add_subplot(111, projection='3d')
            #ax  = fig.add_subplot(111)     
            ax.scatter(DirEcc_GTM,DirMass_GTM,GTM_Sigma_AllOrbits,marker='o')
         ...
         try:
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    try:
                        print('================')
                        print('Making TTm vs time plot for '+str(data_frame[n]['DirName']))
                        print('================')
                    except:
                        print('================')
                        print('Dir error')
		    ...
		    print(TTm)
                    ...
                    Dir_alpha_patches            = mpatches.Patch(color='white',label=r'$\alpha$ :'+str(alpha))
                    Dir_beta_patches             = mpatches.Patch(color='white',label=r'$\beta$ :'+str(beta))
                    Dir_TTm_patches              = mpatches.Patch(color='white',label=r'$\beta$ :'+str(TTm_rate))
                    ...
                    plt.savefig('Standard_TTm_'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close()
                    os.system('git add *.png')
         ...
         try:
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    try:
                        print('================')
                        print('Making Perihelion plot for '+str(data_frame[n]['DirName']))
                        print('================')
                    except:
                        print('================')
                        print('Dir error')
                    ...
                    plt.plot(data_frame[n]['t'],data_frame[n]['long_perihelion'],color='red')
                    ...
                    plt.savefig('Standard_Precession_Check_'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close()
                    os.system('git add *.png')
         ...
         try:
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    plt.savefig('Standard_Precession_Check_10_Orbits'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close()
                    os.system('git add *.png')
        ...
        try: 
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    try:
                        print('================')
                        print('Making Torque plot for '+str(data_frame[n]['DirName']))
                        print('================')
                    except:
                        print('================')
                        print('Dir error')
                    ...
                    ax1.plot(data_frame[n]['time'],data_frame[n]['torqint'],'--',label='Inner')
                    ax1.plot(data_frame[n]['time'],data_frame[n]['torqext'],'--',label='Outer')
                    ax1.plot(data_frame[n]['time'],data_frame[n]['torqtotal'],label='Total')
                    ax1.plot(data_frame[n]['time'],data_frame[n]['tanaka_array'],linestyle=':',label='Tanaka et  al. 2002')
                    ax1.set_aspect('auto')
                    plt.xlim([0,data_frame[n]['tmax']])
                    plt.tight_layout()
                    plt.grid(True)
                    ...
                    plt.savefig('Standard_Torque_'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
                    os.system('git add *.png')
        ...
        try: 
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    try:
                        print('================')
                        print('Making Dynamic Contour plots for '+str(data_frame[n]['DirName']))
                        print('================')
                    except:
                        print('================')
                        print('Dir error')
			...
			#=========================
	                    ...
	                    fig,(ax1)=plt.subplots(1,1,figsize=(10,10))
	                    fig.subplots_adjust(bottom=0.07,top=0.95)
        	            PL2=ax1.contourf(x2d,y2d,Dynamic_Density[Dynamic_Loop][:],ncolors)
		    ...
		    if Calc_Temp == True:
				...
				#=========================
				    ...
				    Normalized_Temp=Dynamic_Temperature[Dynamic_Loop][:]/Init_Temp[:]
		                    ...
		                    fig,(ax1)=plt.subplots(1,1,figsize=(10,10))
		                    fig.subplots_adjust(bottom=0.07,top=0.95)
		                    ax1.contourf(x2d,y2d,Dynamic_Temperature[Dynamic_Loop][:]/Init_Temp[:],ncolors)
		                    ax1.set_aspect('equal')
		    ...
		    while Dynamic_Loop <= len(Dynamic_Shock)-1:
			    ...
			    fig,(ax1)=plt.subplots(1,1,figsize=(10,10))
                    	    fig.subplots_adjust(bottom=0.07,top=0.95)
                    	    ax1.contourf(x2d,y2d,Dynamic_Shock[Dynamic_Loop][:],ncolors)
                    	    ax1.set_aspect('equal')
        ...
        try: 
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    try:
                        print('================')
                        print('Making Contour plots for '+str(data_frame[n]['DirName']))
                        print('================')
                    except:
                        print('================')
                        print('Dir error')
		    ...
		    if Calc_Temp == True:
			    ...
			    Normalized_Temp=[]
                    ...
                    plt.suptitle('t='+str(data_frame[n]['ivar']))
                    plt.subplots_adjust(bottom=0.05,top=0.95)
                    plt.savefig('Midplane_Contour_Density_'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
		    ...
		    #
		            ...
		            plt.suptitle('t='+str(data_frame[n]['ivar']))
		            plt.subplots_adjust(bottom=0.05,top=0.95)
		            plt.savefig('Midplane_Contour_Temp_'+str(data_frame[n]['DirName'])+'.png')
		            #too many figs may be open.
		            #close plots once done
		            plt.close(fig)
		    #
			...
			print('================')
                    ...
                    plt.suptitle('t='+str(data_frame[n]['ivar']))
                    plt.subplots_adjust(bottom=0.05,top=0.95)
                    plt.savefig('Midplane_Contour_Shock_'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
	...
	Calc_Temp	    =   self.Calc_Temp
        ...
        try: 
		    ...
		    yrq2	 =   data_frame[n]['yrq2']
                    ...
                    plt.suptitle('t='+str(data_frame[n]['ivar']))
                    plt.subplots_adjust(bottom=0.05,top=0.95)
                    plt.savefig('Standard_Contour_Density_'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
		    ...
		    #
		            ...
		            plt.suptitle('t='+str(data_frame[n]['ivar']))
		            plt.subplots_adjust(bottom=0.05,top=0.95)
		            plt.savefig('Standard_Contour_Temp_'+str(data_frame[n]['DirName'])+'.png')
		            #too many figs may be open.
		            #close plots once done
		            plt.close(fig)
		    #
			...
			print('================')			
                    ...
                    plt.suptitle('t='+str(data_frame[n]['ivar']))
                    plt.subplots_adjust(bottom=0.05,top=0.95)
                    plt.savefig('Standard_Contour_Shock_'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
		    ...
		    ax1.plot(xrq2,yrq2,color='orange')
                    ...
                    plt.suptitle('t='+str(data_frame[n]['ivar']))
                    plt.subplots_adjust(bottom=0.05,top=0.95)
                    plt.savefig('Standard_Contour_Trace_Density_'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
		    ...
		    #
			    ...
			    ax1.plot(xrq2,yrq2,color='orange')
		            ...
		            plt.suptitle('t='+str(data_frame[n]['ivar']))
		            plt.subplots_adjust(bottom=0.05,top=0.95)
		            plt.savefig('Standard_Contour_Trace_Temp_'+str(data_frame[n]['DirName'])+'.png')
		            #too many figs may be open.
		            #close plots once done
		            plt.close(fig)
		    #
			...
			print('================')
			print('Not plotting temperture for Standard contour plot Traces')
			print('================')			
		    ...
		    ax1.plot(xrq2,yrq2,color='orange')
                    ...
                    plt.suptitle('t='+str(data_frame[n]['ivar']))
                    plt.subplots_adjust(bottom=0.05,top=0.95)
                    plt.savefig('Standard_Contour_Trace_Shock_'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
		    ...
		    #=========================
                    ...
                    plt.suptitle('t='+str(data_frame[n]['ivar']))
                    plt.subplots_adjust(bottom=0.05,top=0.95)
                    plt.savefig('Standard_Profile_Density_'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
		    ...
		    #
		            ...
		            plt.suptitle('t='+str(data_frame[n]['ivar']))
		            plt.subplots_adjust(bottom=0.05,top=0.95)
		            plt.savefig('Standard_Profile_Temperature_'+str(data_frame[n]['DirName'])+'.png')
		            #too many figs may be open.
		            #close plots once done
		            plt.close(fig)
		    #
			...
			print('================')
			print('Not plotting temperture for Standard contour plot radial Profile')
			print('================')			
                    ...
                    plt.suptitle('t='+str(data_frame[n]['ivar']))
                    plt.subplots_adjust(bottom=0.05,top=0.95)
                    plt.savefig('Standard_Profile_Shock_'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
        ...
        try: 
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    try:
                        print('================')
                        print('Making Ecc plot for '+str(data_frame[n]['DirName']))
                        print('================')
                    except:
                        print('================')
                        print('Dir error')
		    ...
		    CN_line	 = data_frame[n]['CN_line']
                    ...
                    ax1.plot(time,eccentricity[:len(time)],label='Pencil-code')
                    ax1.plot(time,CN_line[:len(time)],label='CN2008',linestyle=':')
                    ...
                    plt.savefig('Standard_Ecc_Decay_'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
        ...
        try: 
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    try:
                        print('================')
                        print('Making Orbital plot for '+str(data_frame[n]['DirName']))
                        print('================')
                    except:
                        print('================')
                        print('Dir error')
        ...
        try: 
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    try:
                        print('================')
                        print('Making Temp Box plot for '+str(data_frame[n]['DirName']))
                        print('================')
                    except:
                        print('================')
                        print('Dir error')
                    ...
                    ax1.set_title(r'$\epsilon$='+str(round(eccentricity[0],1)))
                    ...
                    plt.savefig('Standard_Temp_Box'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig1)
                    os.system('git add *.png')
