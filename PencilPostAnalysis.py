...
class Pencil_Post_Analysis(object):
    ...
    def Make_Vars(self):
        ...
        while i <= len(dir_run_list)-1:
            var_dir_list.append(data_functions.grepDATA(dir_run_list[i],Orbit,Calc_Temp=True,Calc_Density=True,step=step)) 
         ...
         try:
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    plt.savefig('Standard_Precession_Check_Post'+str(data_frame[n]['DirName'])+'.png')
         ...
         try:
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    plt.savefig('Standard_Precession_Check_10_Orbits_Post'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close()
                    os.system('git add *.png')
        ...
        try: 
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    plt.savefig('Standard_Torque_Post'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
                    os.system('git add *.png')
        ...
        try: 
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    plt.subplots_adjust(bottom=0.05,top=0.95)
                    plt.savefig('Standard_Contour_Density_Post'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
                    ...
                    plt.suptitle('t='+str(data_frame[n]['ivar']))
                    plt.subplots_adjust(bottom=0.05,top=0.95)
                    plt.savefig('Standard_Contour_Temp_Post'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
                    ...
                    plt.suptitle('t='+str(data_frame[n]['ivar']))
                    plt.subplots_adjust(bottom=0.05,top=0.95)
                    plt.savefig('Standard_Contour_Shock_Post'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
                    ...
                    plt.suptitle('t='+str(data_frame[n]['ivar']))
                    plt.subplots_adjust(bottom=0.05,top=0.95)
                    plt.savefig('Standard_Profile_Density_Post'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
                    ...
                    plt.suptitle('t='+str(data_frame[n]['ivar']))
                    plt.subplots_adjust(bottom=0.05,top=0.95)
                    plt.savefig('Standard_Profile_Temperature_Post'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
                    ...
                    plt.suptitle('t='+str(data_frame[n]['ivar']))
                    plt.subplots_adjust(bottom=0.05,top=0.95)
                    plt.savefig('Standard_Profile_Shock_Post'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
        ...
        try: 
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    plt.savefig('Standard_Ecc_Decay_Post'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
                    os.system('git add *.png')
        ...
        try: 
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    plt.savefig('Standard_Orbit_Info_Post'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig)
        ...
        try: 
            ...
            while n <= len(data_frame)-1:
                try:
                    ...
                    plt.savefig('Standard_Temp_Box_Post'+str(data_frame[n]['DirName'])+'.png')
                    #too many figs may be open.
                    #close plots once done
                    plt.close(fig1)
                    os.system('git add *.png')
